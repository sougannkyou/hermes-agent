  ...
  - description: 全网搜帖子或评论
    ...
    params:
      ...
      start:
        ...
        required: false
        type: integer
    path: /acp/v1/skill-run/istarshine-domestic-web-wide-search/widesearch/v1
  - description: 全网搜统计分析
    method: POST
    params:
      metrics:
      ...
      q:
        ...
        required: false
        type: string
    path: /acp/v1/skill-run/istarshine-domestic-web-wide-search/api/wide-stats
  - description: 查询可用 MCN 机构标签列表
    method: GET
    path: /acp/v1/skill-run/istarshine-domestic-web-wide-search/api/labels/mcn
  - description: 查询可用采编权标签列表
    method: GET
    path: /acp/v1/skill-run/istarshine-domestic-web-wide-search/api/labels/cbq
  metering: per_request
  rate_limit: 100/day
description: '搜索超过 10 年的中国境内社交媒体和新闻等数据，覆盖抖音、快手、微博、小红书等社交媒体，新华网、人民网、澎湃新闻等新闻媒体，腾讯新闻、网易新闻、今日头条、懂车帝等门户网站，微信公众号、微信视频号、微头条等自媒体，以及政府网站公告新闻等。
  包括帖子、新闻、评论、转发和弹幕。 支持关键词搜索、热词、话题、情感分析、趋势、平台对比、标签联合查询和统计分析。 兼容 Google Custom Search
  JSON API 响应格式。 当用户需要搜索中国境内互联网上的帖子、新闻、评论、热词、话题、情感、趋势、平台对比或标签统计分析时使用。 不要用于互动数据刷新（请使用
  istarshine-refresh-interact）、 URL 归一化（请使用 istarshine-normalize-url）、 或热榜/热搜数据（请使用
  istarshine-trending-search）。 如果只需搜索抖音和微博两个平台，请使用 istarshine-douyin-weibo-search。
...
metadata:
  ...
  - 数据
  version: 0.24.2
name: istarshine-domestic-web-wide-search
---

# istarshine-domestic-web-wide-search — 国内全网搜 Skill

## When to use

- 搜索中国境内互联网平台上的帖子、新闻、评论、转发
- 覆盖抖音、快手、微博、小红书等社交媒体
- 覆盖新华网、人民网、澎湃新闻等新闻媒体
- 覆盖腾讯新闻、网易新闻、今日头条、懂车帝等门户网站
- 覆盖政府网站公告新闻
- 分析热词、话题、情感、趋势
- 对比多个平台的数据分布
...
- 社交媒体：抖音、快手、微博、小红书、贴吧、B站等
- 新闻媒体：新华网、人民网、澎湃新闻、央视新闻等
- 门户网站：腾讯新闻、网易新闻、今日头条、搜狐新闻、懂车帝、有驾等
- 政府网站：各级政府网站公告新闻
- 其他：微信公众号、微信视频号、微头条等
- 数据类型：原创帖/短视频、新闻文章、转发帖、评论、弹幕
- 时间范围：超过 10 年的历史数据，默认最近 7 天
